...
import { RGBELoader } from './third-party/three/examples/jsm/loaders/RGBELoader.js';
import { KTX2Loader } from './third-party/three/examples/jsm/loaders/KTX2Loader.js';
...
export class ThreeView {
    ...
    _initScene(rootPath, gltfContent) {
        ...
        // var dracoLoaderPathAndFile = document.getElementById('/js/third-party/three/examples/js/libs/draco/gltf/').textContent;
        ...
        loader.setKTX2Loader( new KTX2Loader().setTranscoderPath( '/js/third-party/three/examples/js/libs/basis/' ).detectSupport( renderer ) );
